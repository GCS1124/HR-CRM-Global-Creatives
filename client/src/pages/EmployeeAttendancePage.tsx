      ...
      >
        <div className="grid gap-4 xl:grid-cols-[1.25fr_0.75fr]">
          <div className="relative overflow-hidden rounded-[28px] border border-brand-200 bg-[linear-gradient(135deg,rgba(26,42,105,0.98),rgba(59,130,246,0.9))] p-5 text-white shadow-[0_24px_60px_rgba(26,42,105,0.24)]">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.18),transparent_34%),radial-gradient(circle_at_bottom_left,rgba(249,115,22,0.18),transparent_28%)]" />
